...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/wizzgeeks/.vscode/extensions/wallabyjs.console-ninja-1.0.406/out/buildHook/index.js').default({tool: 'webpack', checkSum: '202d75b59d525930a98e3eB0oODUwFA1UGUwNaCwRRAQ5QUlID', mode: 'build'}); } catch(cjsError) { try { import('file:///home/wizzgeeks/.vscode/extensions/wallabyjs.console-ninja-1.0.406/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '202d75b59d525930a98e3eB0oODUwFA1UGUwNaCwRRAQ5QUlID', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
